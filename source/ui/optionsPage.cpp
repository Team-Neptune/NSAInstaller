...
namespace inst::ui
{
    ...
    {
        if (ourBool)
            return "romfs:/images/icons/check-box-outline.png";
        else
            return "romfs:/images/icons/checkbox-blank-outline.png";
    }
    ...
    void optionsPage::onInput(u64 Down, u64 Up, u64 Held, pu::ui::Touch Pos)
    {
        ...
        if ((Down & KEY_A) || (Up & KEY_TOUCH))
        {
            ...
            case 1:
                ...
                {
                    if (inst::ui::mainApp->CreateShowDialog("options.nca_warn.title"_lang, "options.nca_warn.desc"_lang, {"common.cancel"_lang, "options.nca_warn.opt1"_lang}, false) == 1)
